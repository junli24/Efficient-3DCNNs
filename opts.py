...
def parse_opts():
    ...
    parser.add_argument('--video_path', default=r'D:\processed_data\mri', type=str, help='Directory path of Videos')
    parser.add_argument('--annotation_path', default=r'C:\Users\96275\Nutstore\1\我的坚果云\Alzheimer\code\Efficient-3DCNNs\adni\train.csv', type=str, help='Annotation file path')
    ...
    parser.add_argument('--model', default='squeezenet', type=str, help='(resnet | preresnet | wideresnet | resnext | densenet | ')
