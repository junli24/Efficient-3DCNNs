...
def parse_opts():
    ...
    parser.add_argument('--resume_path', default='results/adni_mobilenet_1.0x_RGB_113_checkpoint.pth', type=str, help='Save data (.pth) of previous training')
    ...
    parser.add_argument('--model', default='mobilenet', type=str, help='(resnet | preresnet | wideresnet | resnext | densenet | ')
