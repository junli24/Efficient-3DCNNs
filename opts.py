...
def parse_opts():
    ...
    parser.add_argument('--video_path', default='mri', type=str, help='Directory path of Videos')
    parser.add_argument('--annotation_path', default=['adni/train.csv', 'adni/test.csv'], nargs='+', type=str, help='Annotation file path')
    ...
    parser.add_argument('--dataset', default='adni', type=str, help='Used dataset (activitynet | kinetics | ucf101 | hmdb51)')
    ...
    parser.add_argument('--sample_size', default=[113, 137], nargs='+', type=int, help='Height and width of inputs')
    parser.add_argument('--sample_duration', default=113, type=int, help='Temporal duration of inputs')
    ...
    parser.add_argument('--resume_path', default='results/adni_shufflenet_1.0x_RGB_113_checkpoint.pth', type=str, help='Save data (.pth) of previous training')
    ...
    parser.set_defaults(no_hflip=True)
    parser.add_argument('--norm_value', default=1, type=int, help='If 1, range of inputs is [0-255]. If 255, range of inputs is [0-1].')
    parser.add_argument('--model', default='shufflenet', type=str, help='(resnet | preresnet | wideresnet | resnext | densenet | ')
