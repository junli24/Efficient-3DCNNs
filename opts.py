...
def parse_opts():
    ...
    parser.add_argument('--video_path', default=r'mri', type=str, help='Directory path of Videos')
    parser.add_argument('--annotation_path', default=r'adni\train.csv', type=str, help='Annotation file path')
